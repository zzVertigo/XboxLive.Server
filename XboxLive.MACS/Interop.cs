...
namespace XboxLive.MACS
{
    public class Interop
    {
        ...
        [Flags]
        public enum KERB_CACHE_OPTIONS : ulong
        {
        ...
        {
            private readonly int Type0;
            public int BlockSize;
            private readonly int Type1;
            public int KeySize;
            public int Size;
            ...
            private readonly IntPtr unk0_null;
            private readonly IntPtr unk1_null;
            private readonly IntPtr unk2_null;
        }
        ...
        public struct KERB_PURGE_TKT_CACHE_REQUEST
        {
            public KERB_PROTOCOL_MESSAGE_TYPE MessageType;
            public LUID LogonId;
            private readonly LSA_STRING_IN ServerName;
            private readonly LSA_STRING_IN RealmName;
        }
        ...
        public struct LUID
        {
            ...
            {
                LowPart = (uint) (value & 0xffffffffL);
            ...
            public LUID(string value)
            {
                ...
                else if (Regex.IsMatch(value, @"^\d+$"))
                {
                    ...
                    var uintVal = ulong.Parse(value);
                    LowPart = (uint) (uintVal & 0xffffffffL);
                    HighPart = (int) (uintVal >> 32);
                }
                else
                {
                    var argEx = new ArgumentException("Passed LUID string value is not in a hex or decimal form",
                        value);
                    throw argEx;
                }
            }
