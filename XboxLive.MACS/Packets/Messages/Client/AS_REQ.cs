...
namespace XboxLive.MACS.Packets.Messages
{
    public class AS_REQ : Message
    {
        ...
        public bool SignatureCheckXClient(byte[] OnlineKey, byte[] Signature)
        {
            ...
            byte[] nonceHmac = secondhash.ComputeHash(SaltedNonce);

            // set the nonceHmac for later
            Array.Copy(nonceHmac, Client.NonceHmacKey, nonceHmac.Length);
        ...
        public override void Process()
        {
            // Client Initialization
            {
                ...
                Array.Copy(OnlineKey, Client.OnlineKey, OnlineKey.Length);
        ...
        public void BuildResponse()
        {
            ...
            // DO not use yet till AS_REP is done!
        }
